...
<script src="<c:url value='/resources/js/branchwise.js'/>"></script>
					...
					<table id="searchtable">
						...
						<tr>
							...
							<td><div
									...
									<select id="bank" name="bank" autofocus>
						...
						<tr>
							...
							<td><input id="branch" type="text" class="text-field branch"
								name="branch" maxlength="6" value="${branch}" /> <!-- 								<input type=hidden id="hidbranch" name="branch" /></td> -->
