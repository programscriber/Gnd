...
<script src="<c:url value='/resources/js/pinawb.js'/>"></script>
	...
	<div class="main" style="">
		<div class="container main-conten">
				...
				<h4>Search By</h4>
					<div class="navigation">
						...
						<li ><a href="${pageContext.request.contextPath}/track">Mobile
							...
							<li class="selected"><a href="${pageContext.request.contextPath}/pinawbpage">Pin AWB</a></li>
			...
			<div class="right-content record">
				<h4 class="blue-text">Air Way Bill/Speed Post</h4>
				<form name="awbsearch1" action="${pageContext.request.contextPath}/pinawb" method="post" onsubmit="return validateForm();">
					...
					<tr>
						<th>Pin AWB</th>
						<td><input id="pinawb" type="text" class="text-field product" value="${pinawb}" name="pinawb" maxlength="13" autofocus/></td>
						<td><label id="pinerrmsg"></label></td>
						</tr>
<!-- 						pattern="/[^a-zA-Z0-9]/" -->
						<tr></tr>
						<tr></tr>
						<tr>
							<td></td>
							<td><input type="submit" class="btn btn-l btn-blue" value="search" /><input type="button"  value="reset" class="btn btn-l" onclick="return resetOne();"/></td>
				</tr>
				</table>
				</form>
...
<!--                     </div> -->
			...
			<tag:paginate max="15" offset="${offset}" count="${count}"
   			uri="${pageContext.request.contextPath}/pinawb?pinawb=${pinawb}" next="&raquo;" previous="&laquo;" />
   			</c:if>
			</c:otherwise>
			</c:choose>
		</div>
