	...
	<div class="main" style="">
		<div class="container main-conten">
					...
					<div class="navigation">
						<ul>
							<li ><a href="${pageContext.request.contextPath}/track">Mobile
									No</a></li>
							<li class="selected"><a href="${pageContext.request.contextPath}/awbsearch">Card AWB</a></li>
			...
			<div class="right-content record">
				...
				<form name="awbsearch" action="${pageContext.request.contextPath}/cardawb" method="post"
					>
					<table id="searchtable">
						...
						<tr>
							<th>Card AWB</th>
							<td><input id="cardawb" type="text" name="cardawb" value="${cardawb}"
								class="text-field awb" maxlength="13" autofocus />
							<td><label id="carderrmsg"></label></td>
						</tr>
						<tr></tr>
						<tr></tr>
						<!-- 						<tr> -->
						<!-- 							<th>Pin AWB</th> -->
						<!-- 						<td><input id="pinawb" type="text" class="text-field product" name="pinawb" maxlength="15" /></td> -->
						<!-- 						</tr> -->
						<!-- <!-- 						pattern="/[^a-zA-Z0-9]/" -->
						<!-- 						<tr></tr> -->
						<!-- 						<tr></tr> -->
...
<!--                         <button  id=" " type="button"  class="btn btn-only-img btn-only-img1 btn-s" onclick="location.href='/sbi/cardawbReport'"> -->
...
<!--                     </div> -->
							...
							<br>
   							...
   							uri="${pageContext.request.contextPath}/cardawb?cardawb=${cardawb}" next="&raquo;" previous="&laquo;" />
							</c:if>
						</c:otherwise>
					</c:choose>
				</div>
