	...
	<div class="main" style="">
		<div class="container main-conten">
				...
				<div class="demo-left-nav" id="left-nav">
					...
					<div class="navigation">
						<ul>
							...
							<li class="selected"><a href="${pageContext.request.contextPath}/rsnpage">RSN </a></li>
			...
			<div class="right-content record">
				<h2 class="blue-text">RSN</h2>
				<form name="rsnsearch" action="${pageContext.request.contextPath}/rsn" method="post">
					<table id="searchtable">
						...
						<tr>
							<th>RSN</th>
							<td><input id="rsn" type="text" class="text-field awb" value="${rsn}"
								maxlength="10" name="rsn"  autofocus/> <!-- 							<input type=hidden id="hidrsn" name="rsn"/></td> -->
