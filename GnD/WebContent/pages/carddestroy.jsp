					...
					<div class="navigation">
						<ul>
							<c:if test="${username eq 'admin'}">
										...
										<li id="prototype" class="selected"><a href="/GnD/shopfloor/carddestroy">Card Destroy</a></li>
...
<!-- 									<li id="prototype"><a href="/GnD/shopfloor/pindestroy">Pin Destroy</a></li> -->
			 ...
			 <div class="right-content" >
                        ...
                        <h2 class="blue-text">Card Destroy</h2>
                            ...
                            <div class="row right-con">
                                <div class="col-md-2">
                                    ...
                                    <div class="select-menu select-menu-native select-menu-light">
										...
										<input id="decisionid" type="hidden" name="decision" value="<%=Card_Destroy%>"/>
                 ...
                 success: function (data) {
                	 ...
                	 if(data.boolRes){
                		 ...
                		 declinePerformance.play();
                			$.alertable.alert("card is not in state to Destroy", {
                       		  show: function() {
                       		    $(this.overlay).velocity('transition.fadeIn');        
                       		    $(this.modal).velocity('transition.flipBounceYIn');
                       		  },
