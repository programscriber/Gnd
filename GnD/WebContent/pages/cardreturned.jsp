...
<!-- 										<li id="prototype" class="selected"><a href="/GnD/shopfloor/cardreturned">card Returned</a></li> -->
...
<!-- 									<li id="prototype"><a href="/GnD/shopfloor/pindestroy">Pin Destroy</a></li> -->
			 ...
			 <div class="right-content" >
			 	<audio id="audioid" style="display:none;" controls >
                        ...
                        <h2 class="blue-text">Card Return</h2>
                     	<form id="rtocardId"
                            ...
                            <div class="row right-con">
                                <div class="col-md-2">
                                    ...
                                    <div class="select-menu select-menu-native select-menu-light">
										...
										<input type="hidden" id="decisionid" name="decision" value="<%=Card_Returned%>"/>
                 ...
                 success: function (data) {
                	 ...
                	 if(data.boolRes){
                		 ...
                		 declinePerformance.play();
                			...
                			$.alertable.alert("CARD IS ALREADY REDISPATCHED ON "+data.eventdate, {
                       		  show: function() {
                       		    $(this.overlay).velocity('transition.fadeIn');        
                       		    $(this.modal).velocity('transition.flipBounceYIn');
                       		  },
