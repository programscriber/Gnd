...
<body>
<%!public static final int Card_awb_Returned = 19; %>	
	<style>
...
<!-- 										<li id="prototype" ><a href="/GnD/shopfloor/cardreturned">card Returned</a></li> -->
										...
										<li id="prototype" class="selected"><a href="/GnD/shopfloor/scanbyAWBtorto">RTO Scan By AWB</a></li>
...
<!-- 									<li id="prototype"><a href="/GnD/shopfloor/pindestroy">Pin Destroy</a></li> -->
				...
				<c:url value="/j_spring_security_logout" var="logoutUrl" />
                        ...
                        <h4 class="blue-text">Scan By AWB To Make Card Return </h4>
				...
				<div class="row right-con">
					<div class="col-md-2">
						<span class="blue-text">CARD AWB Value</span>
						<div class="select-menu select-menu-native select-menu-light">
							<form id="rtocardId"
								...
								<input   id="decisionid" type="hidden" name="decision" value="<%=Card_awb_Returned %>"/>
 ...
 <center>  <h1>CARDS WHICH ARE ALREADY IN REDISPATCH STATE</h1></center> 
    <table id="redispatchedCards" class="table">
    </table>
<!--     <button id=savefile class="btn btn-l btn-blue ">save to file</button> -->
  </div>
		...
		var successCount = 0;
		 var resiapatch='<tr><td>CARD AWB</td><td>RSN</td><td>Dedispatch time</td></tr>';
	    ...
	    frmrto.submit(function (ev) {
            ...
            $.ajax({
              ...
              $('#awb').val('');
              var  returncards=data.shopFloorDetailsreturnResult;
              ...
              if(returncards!=null&&returncards.length>0){           	 
            	  ...
            	  successCount+=1;
             	  ...
             	  if(returncard.redispatachAgain){
             		 resiapatch+='<tr><td>'+returncard.cardAWB+'</td><td>'+returncard.rsn+'</td><td>'+returncard.eventdate+'</td></tr>';
             		 yesNo=true;
             	  }             
            	  }                	
              ...
              if(yesNo){
            	  $("#redispatchedCards > tbody").html("");
            	  var declinePerformance = $("#audioid")[0];
         		  declinePerformance.play();
            	  $('#redispatchedCards').html(resiapatch);
