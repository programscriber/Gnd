	...
	<div class="main" style="">
		<div class="container main-conten">
			...
			<div class="right-content record">
				<h2 class="blue-text">Daily Notifications</h2>
				<form name="dailymailing" onsubmit = "return validateMail(emailfieldReject.value, emailfieldHold.value, emailfieldApproved.value)" action="/GnD/notification/daily">
...
<%-- 									</c:if>									 --%>
	...
	function formSubmit() {
		...
		$(function() {
			...
			var product = [ "Product 1", "Product 2", "Product 3", "Product 4" ];
