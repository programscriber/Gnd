	...
	<div class="main" style="">
		<div class="container main-conten">
			...
			<div class="right-content record">
				<!-- 				<h2 class="blue-text">Mobile Number Search</h2> -->
				<form name="search" action="${pageContext.request.contextPath}/mobileno" method="post"
				>  
					<table id="searchtable">
						...
						<tr>
							<th>Mobile Number</th>
							<td><input id="mobile" type="text" class="text-field mobile"
								maxlength="10" value="${mobile}" name="mobile" autofocus/> <!-- 								<input type=hidden -->
								<!-- 								id="hidmobile" name="mobile"  /> --></td>
							<td><label id="errmsg"></label></td>
						</tr>
						<tr><td></td><td>please enter 10 digit mobile number</td></tr>
						<tr></tr>
						<tr></tr>
						<tr>
							<td></td>
							<td><input type="button" class="btn btn-l btn-blue"
				...
				<p>${downloadResult}</p>
<%-- 		<a href="/sbi/mobileReport?mobileNumber=${records}" class="btn btn-l">generate Report</a> --%>
...
<!-- 							<br> -->
<!-- 							<br> -->
<!-- 							<a href="/sbi/mobileReport" class="btn btn-l">generate Report</a> -->
<!-- 							<br> -->
<!-- 							<br> -->
<!-- 							<br> -->
...
<!-- <!--                        <h3>Search Results : 14 Records</h3> -->
<!--                         <button  id=" " type="button"  class="btn btn-only-img btn-only-img1 btn-s" onclick="location.href='/sbi/mobileReport'"> -->
...
<!--                         </button> -->
							...
							<tag:paginate max="15" offset="${offset}" count="${count}"
   							uri="${pageContext.request.contextPath}/mobileno?mobile=${mobile}" next="&raquo;" previous="&laquo;" />
			...
			<div class="footer-columns">
				<div class="footer-left-column">
					<div class="footer-version">
						<strong>Web Tracking Tool</strong> Web Tracking Tool Version 1.0.14
					</div>
					<!-- 			"${count}"		<ul class="footer-links"> -->
