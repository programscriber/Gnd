...
<script src="<c:url value='/resources/js/bankaccountno.js'/>"></script>
	...
	<div class="main" style="">
		<div class="container main-conten">
				...
				<div class="demo-left-nav" id="left-nav">
					...
					<div class="navigation">
						...
						<li ><a href="${pageContext.request.contextPath}/track">Mobile
							...
							<li class="selected"><a href="${pageContext.request.contextPath}/prerequesttoadd">Bank and ac no </a></li>
			...
			<div class="right-content record">
				<h2 class="blue-text">Bank and Account No</h2>
				<form name="backacc" action="${pageContext.request.contextPath}/searchbybank" method="post"
					onsubmit="return validateForm();">
					<table id="searchtable">
						<tr>
							<th>Bank</th>
							<td><div
									class="select-menu select-menu-native select-menu-light">
									<select id="bankid1" name="bank">
						...
						<tr>
							...
							<td><input id="acctNo" type="text" class="text-field" value="${acctNo}"
								size="100px" name="acctNo" maxlength="17"  />
							<td><label id="errmsg"></label></td>
							<!-- 								<input type=hidden id="hidacctNo" name="acctNo" /></td> -->
						</tr>
...
<!--                         <button  id=" " type="button"  class="btn btn-only-img btn-only-img1 btn-s" onclick="location.href='/sbi/searchbybankReport'"> -->
...
<!--                     </div>				 -->
   							...
   							uri="${pageContext.request.contextPath}/searchbybank?bank=${bank}&acctNo=${acctNo}" next="&raquo;" previous="&laquo;" />
							</c:if>
						</c:otherwise>
					</c:choose>
				</div>
